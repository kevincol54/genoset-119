...
This script determines if you have an increased risk for developing breast cancer, as per [gs119](http://www.snpedia.com/index.php/Gs119)
...
```js
var increasedRisk = require('genoset-119');
...
_genoset-119_ is available under the [MIT](https://mths.be/mit) license.
